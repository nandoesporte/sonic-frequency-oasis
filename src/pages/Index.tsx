  ...
  return (
    <AudioProvider>
      <div className="min-h-screen">
        ...
        {/* Hero Section */}
        <section className="pt-28 md:pt-32 pb-16 px-4 relative overflow-hidden bg-gradient-to-b from-purple-100/80 to-background dark:from-purple-900/30 dark:to-background">
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl mx-auto">
                ...
                <div className="flex flex-col items-center bg-white/50 dark:bg-white/5 p-4 rounded-xl backdrop-blur-sm shadow-sm">
                  ...
                  <h3 className="font-medium">Resultado Imediato</h3>
                  <p className="text-sm text-muted-foreground">Relaxamento em minutos</p>
                </div>
                <div className="flex flex-col items-center bg-white/50 dark:bg-white/5 p-4 rounded-xl backdrop-blur-sm shadow-sm">
        ...
        {/* Problem Section */}
        <section className="py-16 bg-gradient-to-t from-purple-50/50 to-transparent dark:from-purple-900/5 dark:to-transparent">
                ...
                <Card className="bg-white/70 dark:bg-white/5 backdrop-blur-sm">
                  <CardContent className="pt-6">
                    <div className="flex flex-col items-center text-center">
                      ...
                      <h3 className="text-xl font-medium mb-2">Tempo para Relaxar</h3>
                      <p className="text-muted-foreground">Clientes que demoram para relaxar ou entrar em estados meditativos.</p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-white/70 dark:bg-white/5 backdrop-blur-sm">
                  <CardContent className="pt-6">
                    <div className="flex flex-col items-center text-center">
                      ...
                      <h3 className="text-xl font-medium mb-2">Diferenciação</h3>
                      <p className="text-muted-foreground">Dificuldade em diferenciar suas sessões da concorrência.</p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-white/70 dark:bg-white/5 backdrop-blur-sm">
                  <CardContent className="pt-6">
                    <div className="flex flex-col items-center text-center">
                      ...
                      <p className="text-muted-foreground">Falta de ferramentas práticas para intensificar os resultados das terapias.</p>
                    </div>
                  </CardContent>
                </Card>
              </div>
              
              <div className="bg-white/80 dark:bg-white/5 p-6 rounded-xl backdrop-blur-sm border border-purple-200 dark:border-purple-800/30">
                <p className="text-lg">
          ...
          <div className="container mx-auto">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                <div className="bg-gradient-to-br from-white/80 to-purple-50/80 dark:from-white/5 dark:to-purple-900/10 p-6 rounded-xl shadow-sm">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      ...
                      <span>Sessões presenciais com sistema de som</span>
                    </li>
                    <li className="flex items-start">
                      <Check className="h-5 w-5 text-primary mr-2 flex-shrink-0 mt-0.5" />
                      <span>Atendimentos online via Zoom ou Meet</span>
                    </li>
                    <li className="flex items-start">
                      <Check className="h-5 w-5 text-primary mr-2 flex-shrink-0 mt-0.5" />
                      <span>Material complementar para prática em casa</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-gradient-to-br from-white/80 to-purple-50/80 dark:from-white/5 dark:to-purple-900/10 p-6 rounded-xl shadow-sm">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      <Check className="h-5 w-5 text-primary mr-2 flex-shrink-0 mt-0.5" />
                      <span>Sessões de Reiki e terapias energéticas</span>
                    </li>
                    <li className="flex items-start">
                      <Check className="h-5 w-5 text-primary mr-2 flex-shrink-0 mt-0.5" />
                      <span>Meditação guiada e mindfulness</span>
                    </li>
                    <li className="flex items-start">
                      <Check className="h-5 w-5 text-primary mr-2 flex-shrink-0 mt-0.5" />
                      <span>Coaching e desenvolvimento pessoal</span>
                    </li>
                    <li className="flex items-start">
                      <Check className="h-5 w-5 text-primary mr-2 flex-shrink-0 mt-0.5" />
                      <span>Hipnoterapia e constelação familiar</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="text-center">
                <Button asChild size="lg" className="rounded-full bg-primary hover:bg-primary/90 text-white shadow-md">
                  <Link to="/auth">
        ...
        {/* Benefits Section */}
        <section className="py-16 px-4 bg-gradient-to-b from-purple-50/50 to-transparent dark:from-purple-900/5 dark:to-transparent">
          <div className="container mx-auto">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                {benefits.map((benefit, index) => (
                  <div key={index} className="flex bg-white/70 dark:bg-white/5 p-5 rounded-xl shadow-sm">
              ...
              <div className="bg-white/80 dark:bg-white/5 rounded-xl p-6 mb-12 shadow-sm">
                <h3 className="text-2xl font-medium mb-4 text-center">Transforme Suas Sessões</h3>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="border border-red-200 dark:border-red-900/30 rounded-lg p-4">
                    <h4 className="font-medium text-red-600 dark:text-red-400 mb-2">Sessões Tradicionais</h4>
                    <ul className="space-y-3">
                      <li className="flex items-start">
                        <span className="text-red-500 mr-2">✖</span>
                        <span className="text-muted-foreground">10-15 minutos para clientes relaxarem</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-red-500 mr-2">✖</span>
                        <span className="text-muted-foreground">Dificuldade para entrar em estado meditativo</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-red-500 mr-2">✖</span>
                        <span className="text-muted-foreground">Mesmas ferramentas que a concorrência</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-red-500 mr-2">✖</span>
                        <span className="text-muted-foreground">Resultados variáveis entre sessões</span>
                      </li>
                    </ul>
                  </div>
                  
                  <div className="border border-green-200 dark:border-green-900/30 rounded-lg p-4">
                    <h4 className="font-medium text-green-600 dark:text-green-400 mb-2">Com Frequências de Alta Performance</h4>
                    <ul className="space-y-3">
                      <li className="flex items-start">
                        <span className="text-green-500 mr-2">✓</span>
                        <span className="text-muted-foreground">3-5 minutos para relaxamento profundo</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-green-500 mr-2">✓</span>
                        <span className="text-muted-foreground">Acesso rápido a estados meditativos</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-green-500 mr-2">✓</span>
                        <span className="text-muted-foreground">Diferenciação clara no mercado</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-green-500 mr-2">✓</span>
                        <span className="text-muted-foreground">Resultados consistentes em cada sessão</span>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                {testimonials.map((testimonial, index) => (
                  <div key={index} className="bg-white/70 dark:bg-white/5 p-6 rounded-xl shadow-sm">
              ...
              <div className="flex justify-center mb-12">
                <div className="bg-amber-100/50 dark:bg-amber-900/20 py-2 px-4 rounded-full flex items-center">
                  <Star className="h-5 w-5 text-amber-500 mr-2 fill-amber-500" />
                  <span className="font-medium text-amber-800 dark:text-amber-300">Mais de 500 terapeutas satisfeitos</span>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* How to Use Section */}
        <section className="py-16 px-4 bg-gradient-to-t from-purple-50/50 to-transparent dark:from-purple-900/5 dark:to-transparent">
          <div className="container mx-auto">
            <div className="max-w-4xl mx-auto">
              <div className="flex items-center gap-3 mb-8 justify-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                <div className="bg-white/70 dark:bg-white/5 rounded-xl p-6 text-center">
                  <div className="w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center mx-auto mb-4">
                    <Headphones className="h-8 w-8 text-primary" />
                  </div>
                  <h3 className="text-xl font-medium mb-2">Sessões Presenciais</h3>
                ...
                <div className="bg-white/70 dark:bg-white/5 rounded-xl p-6 text-center">
                  ...
                  <h3 className="text-xl font-medium mb-2">Sessões Online</h3>
                  <p className="text-muted-foreground">
                ...
                <div className="bg-white/70 dark:bg-white/5 rounded-xl p-6 text-center">
                  ...
                  <h3 className="text-xl font-medium mb-2">Material Complementar</h3>
                  <p className="text-muted-foreground">
              ...
              {/* Bonus Section */}
              <div className="bg-gradient-to-r from-purple-100/70 to-purple-200/50 dark:from-purple-900/20 dark:to-purple-800/10 rounded-xl p-6 mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-white/60 dark:bg-white/5 rounded-lg p-4">
                    <h4 className="font-medium text-primary mb-2">Guia Prático</h4>
                  ...
                  <div className="bg-white/60 dark:bg-white/5 rounded-lg p-4">
                    <h4 className="font-medium text-primary mb-2">Playlists Personalizadas</h4>
                    <p className="text-sm text-muted-foreground">
                  ...
                  <div className="bg-white/60 dark:bg-white/5 rounded-lg p-4">
                    <h4 className="font-medium text-primary mb-2">Comunidade Exclusiva</h4>
                    <p className="text-sm text-muted-foreground">
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto">
            <div className="max-w-4xl mx-auto">
              <div className="flex items-center gap-3 mb-8 justify-center">
                <Package className="h-8 w-8 text-primary" />
                <h2 className="text-3xl md:text-4xl font-bold text-center">Eleve Suas Sessões por Apenas R$ 97,00</h2>
              </div>
              
              <div className="bg-white/80 dark:bg-white/5 rounded-xl p-8 shadow-md border border-purple-200/50 dark:border-purple-800/30 mb-12">
                <div className="text-center mb-6">
                  <p className="text-xl mb-2">
                    Por apenas <span className="text-2xl font-bold text-primary">R$ 97,00</span>
                    <span className="text-muted-foreground ml-2 text-sm">(ou 12x de R$ 9,70)</span>
                  </p>
                  <p className="text-muted-foreground">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4 mb-8">
                  <div className="flex items-start">
                    ...
                    <span>Coleção completa de Frequências de Alta Performance</span>
                  </div>
                  <div className="flex items-start">
                    <Check className="h-5 w-5 text-green-500 mr-3 flex-shrink-0 mt-0.5" />
                    <span>Bônus exclusivos para terapeutas</span>
                  </div>
                  <div className="flex items-start">
                    <Check className="h-5 w-5 text-green-500 mr-3 flex-shrink-0 mt-0.5" />
                    <span>Atualizações gratuitas de novos áudios</span>
                  </div>
                  <div className="flex items-start">
                    <Check className="h-5 w-5 text-green-500 mr-3 flex-shrink-0 mt-0.5" />
                    <span>Garantia de 7 dias: devolução integral do valor</span>
                  </div>
                </div>
                
                <div className="text-center">
                  <Button asChild size="lg" className="rounded-full bg-primary hover:bg-primary/90 text-white shadow-md text-lg px-10">
                    <Link to="/auth">
        ...
        <section className="py-16 px-4 bg-gradient-to-b from-purple-50/50 to-transparent dark:from-purple-900/5 dark:to-transparent">
          <div className="container mx-auto">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="bg-white/80 dark:bg-white/5 rounded-xl p-6 shadow-sm">
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto">
            <div className="max-w-4xl mx-auto">
              <div className="bg-gradient-to-r from-purple-500/10 to-blue-500/10 dark:from-purple-500/20 dark:to-blue-500/20 rounded-xl p-8 text-center">
                <h2 className="text-3xl md:text-4xl font-bold mb-4">Pronto para Transformar Suas Sessões?</h2>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Button asChild variant="outline" size="lg" className="rounded-full border-purple-300 dark:border-purple-700">
                    <Link to="/scientific">
                      Ver Base Científica
                    </Link>
                  </Button>
        ...
        {/* Footer with contact */}
        <section className="py-12 px-4 bg-gradient-to-t from-purple-100/30 to-transparent dark:from-purple-900/10 dark:to-transparent">
          <div className="container mx-auto">
            <div className="max-w-4xl mx-auto">
              <div className="flex flex-col md:flex-row justify-between gap-8">
                <div className="flex-1">
                  ...
                  <p className="text-muted-foreground mb-2">Ficou com alguma dúvida? Entre em contato:</p>
                  <a href="mailto:contato@kefersolucoes.com.br" className="text-primary hover:underline">contato@kefersolucoes.com.br</a>
                  <p className="mt-4 text-muted-foreground">WhatsApp: (44) 99727-0698</p>
                </div>
                
                <div className="flex-1">
                  <h3 className="text-xl font-semibold mb-4">Informações Legais</h3>
                  <p className="text-muted-foreground mb-2">CNPJ: 14.164.334/0001-05</p>
                  <p className="text-muted-foreground mb-4">Avenida Doutor Luiz Teixeira Mendes, 3096 - Zona 05, Maringa - PR</p>
